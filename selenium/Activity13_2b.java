...
public class Activity13_2b {
    ...
    public static void main(String[] args) {
        ...
        String filePath = "src/SeleniumActivities/sample_13_2.xlsx";
    ...
    public List<List<String>> readExcel(String filePath) {
        ...
        try {
            ...
            XSSFWorkbook workbook = new XSSFWorkbook(file);//Create Workbook instance holding reference to Excel file
            ...
            while(rowIterator.hasNext()) {
                List<String> rowData = new ArrayList<String>(); //Temp variable
                ...
                data.add(rowData); //Store row data in List
            }
            file.close();
            workbook.close();
        }
