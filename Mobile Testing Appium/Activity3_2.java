...
public class Activity3_2 {
	    ...
	    public void imageScrollTest() {
	        ...
	        wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.xpath("//android.view.View[contains(@text, 'Lazy Loading')]")));
		    String PageTitle = driver.findElementByXPath("//android.view.View[contains(@text, 'Lazy Loading')]").getText();
			Assert.assertEquals(PageTitle, "Lazy Loading");
			System.out.println("The new page title is: " + PageTitle); 
