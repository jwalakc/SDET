...
public class JobsScenarios extends BaseClass {
	...
	//Create User
	    ...
	    public void details() {
	    	driver.findElement(By.id("user_login")).sendKeys("jwala1");
	    	driver.findElement(By.id("email")).sendKeys("emailid1@gmail.com");
	    	driver.findElement(By.id("first_name")).sendKeys("Name1");
	    	driver.findElement(By.id("last_name")).sendKeys("Name2");
	    	driver.findElement(By.id("url")).sendKeys("website1");	    	
	    ...
	    public void verfiyUsers() {
	    	driver.findElement(By.name("s")).sendKeys("jwala1");
	    	driver.findElement(By.id("search-submit")).click();
	    	String username = driver.findElement(By.linkText("jwala1")).getText();
	    	System.out.println("The new user added is: " + username);
	    	Assert.assertEquals(username, "jwala1");  	
	    }
	...
	//Search and Apply for Job
	    ...
	    public void jobDetails() {
	    	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//h3[text() = 'Automation tester']")));
	    	driver.findElement(By.xpath("//h3[text() = 'Automation tester']")).click();   
	    	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//h1[text() = 'Automation tester']")));
	    }
	    
	    @Then("^Find the title of the job listing using XPath and print it to the console$")
	    public void jobTitle() {
	    	String jobTitle = driver.findElement(By.xpath("//h1[text() = 'Automation tester']")).getText(); 
	    	System.out.println("The title of the job listing is: " + jobTitle);
	    	Assert.assertEquals(jobTitle, "Automation tester");
