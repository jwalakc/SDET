...
public class hrmScenarios extends BaseClass {
	...
	//Add Candidate
	    ...
	    public void candidateDetails() {
	    	driver.findElement(By.xpath("//input[contains(@id, 'firstName')]")).sendKeys("Jwala"); 
	    	driver.findElement(By.xpath("//input[contains(@id, 'lastName')]")).sendKeys("Cheriyan"); 
	    ...
	    public void resume() {
	    	driver.findElement(By.xpath("//input[contains(@id, 'resume')]")).sendKeys("C:\\Users\\JwalaCheriyan\\eclipse-workspace\\CucumberProject\\src\\test\\resources\\Resume.docx"); 
	    	//driver.findElement(By.xpath("//input[contains(@id, 'resume')]")).sendKeys("src/test/resources/Resume.docx");
	    }
	    ...
	    public void verifyCandidate() {
	    	...
	    	Assert.assertEquals(firstName, "Jwala");
	    	Assert.assertEquals(lastName, "Cheriyan");
