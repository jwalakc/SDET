...
Feature: HRM Scenarios
  ...
  Scenario: To create a job vacancy for “DevOps Engineer”
    ...
    And Fill out the details like "DevOps Engineer", "DevOps vacancy J1", "Hugh Jackman", "3"
 ...
 #   And Close the browser  
  ...
  Scenario Outline: Add multiple employees using the Examples table
    ...
    Examples: 
      ...
      | Jwala1 		|  cc1			| 12111 			|	jwjw1 		|
      | Jwala2 		|  cc2			| 12122 			|	jwjw2			|
  ...
  Scenario Outline: Creating multiple vacancies using data from an Examples table
    ...
    Examples: 
      ...
      | Rust Engineer	  | Engineer vacancy J1		| Amy Russo			 |	10				|
      | Java Developer  | Developer vacancy J2	| Tim Long			 |	7					|
