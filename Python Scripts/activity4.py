...
while True:
    ...
    play1 = input("Does Player1 want to play another round?").lower()
    play2 = input("Does Player2 want to play another round?").lower()
    if (play1 == "yes") and  (play2 == "yes"):
        pass
    elif(play1 not in ("yes", "no") or play2 not in ("yes", "no")):
